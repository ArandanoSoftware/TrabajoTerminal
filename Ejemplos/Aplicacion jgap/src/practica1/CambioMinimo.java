...
public class CambioMinimo {
    ...
    public static void calcularCambioMinimo(int Monto) throws Exception {
        ...
        // --------------------------------------------------------------
        // *****cambio de el numero de monedas por el número de monedas ecuatorianas
        ...
        System.out.println("" + CambioMinimoFuncionAptitud.getNumeroDeComendasDeGen(cromosomaMasApto, 0) + " Moneda 1 dólar");
